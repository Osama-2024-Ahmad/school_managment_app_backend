...
class Grade(models.Model):
    ...
    subject = models.ForeignKey(
        Subject, on_delete=models.CASCADE, related_name="grades", null=True, blank=True
    )
...
class Review(models.Model):
    user = models.ForeignKey(
        FeedbackUser, on_delete=models.CASCADE, null=True, blank=True
    )
    program = models.ForeignKey(
        Program, on_delete=models.CASCADE, related_name="reviews"
    )
...
class Testimonial(models.Model):
    user = models.ForeignKey(
        FeedbackUser, on_delete=models.SET_NULL, null=True, blank=True
    )
